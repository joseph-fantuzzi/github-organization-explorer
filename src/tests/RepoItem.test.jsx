...
describe("Repository Item Component Tests", () => {
  test("repository item component renders properly", () => {
    render(
      <Router>
        <RepoItem repo={repo} />
      </Router>
  ...
  test("repository item component includes correct text", () => {
    render(
      <Router>
        <RepoItem repo={repo} />
      </Router>
    ...
    const text = screen.getByText("Hystrix");
    expect(text).toBeInTheDocument();
  });

  test("repository item component includes main language for that repo", () => {
    render(
      <Router>
        <RepoItem repo={repo} />
      </Router>
    ...
    const lang = screen.getByText("Java");
