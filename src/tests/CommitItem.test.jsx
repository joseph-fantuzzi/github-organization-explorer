...
describe("Commit Item Component Tests", () => {
  test("commit item component renders properly", () => {
    render(
      <Router>
        <CommitItem commit={commit} copyShaHash={vi.fn()} copied={null} />
      </Router>
    );
  });

  test("commit item component includes correct text", () => {
    render(
      <Router>
        <CommitItem commit={commit} copyShaHash={vi.fn()} copied={null} />
      </Router>
    ...
    const text = screen.getByText(/Merge pull request #1904/);
    expect(text).toBeInTheDocument();
  });

  test("commit item component includes main language for that repo", () => {
    render(
      <Router>
        <CommitItem commit={commit} copyShaHash={vi.fn()} copied={null} />
      </Router>
    ...
    const name = screen.getByText("Tim Bozarth");
