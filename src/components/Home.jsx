        ...
        <div className="w-full">
          <form onSubmit={handleFormSubmit} className="flex items-center gap-2">
            <input
              ...
              className="right-animation bg-white p-3.5 rounded-xl font-light text-sm w-full border-2 border-white focus:outline-none focus:border-black transition duration-300 ease dark:bg-black dark:focus:bg-white dark:focus:border-white dark:text-white dark:focus:text-black"
            />
            <button
